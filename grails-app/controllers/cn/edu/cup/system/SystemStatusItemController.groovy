...
class SystemStatusItemController {
    ...
    def save(SystemStatusItem systemStatusItem) {
        ...
        withFormat {
            js { render "alert('systemStatusItem创建成功!')" }

            json { render systemStatusItem as JSON }
    ...
    def importFromJsonFile() {
        ...
        def objectList = commonService.importObjectArrayFromJsonFileName(fileName, SystemStatusItem.class)
